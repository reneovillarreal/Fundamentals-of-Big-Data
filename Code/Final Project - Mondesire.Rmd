...
column_classes <- c("factor", "character", "factor", "factor", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double") #creates a vector with column classes

data_all <- lapply(file_list, function(x) read.csv(x, colClasses = column_classes)) %>% bind_rows #applies read.csv to all files in file list and column classes. Then binds the data together.
...
question1_mean_temp
```
Broward county has the highest average temperature with 81.9 degrees F. Miami Dade comes in a close second with 81.2 degrees F. Fresno has a standard deviation of 12 degrees, meaning their data points are very spead out. <br><br>
...
```
Wisconsin and New York do not collect sunshine data. While no state has any correlation between sunshine and temperature, Florida has the higehst with 0.09. <br> <br>
...
ggplot(q10Prediction, aes(x = Temp)) +
  ...
  labs(title = "Temperature vs Rain",
       ...
       caption = "Source: NOAA")
```
The highest the temperature, the more the model predicts rain to be.
<br><br>
...
plot(q8Decomp)
```
The data is very volatile, as evidence by the randomness graph. It is also very seasonal, as expected. Rain amounts have increased over the past ten years.
<br><br>
...
```
Due to the volaitilty of the data, the error for our forecast are wide even with near term predictions.
<br><br>
